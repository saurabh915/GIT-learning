    ...
    for(int i=0; i<s; i++){
        ...
        for(int j=0; j<n; j++){
            ...
            for(int k=0; k<m; k++){
                ...
                if (j==0 && arr[j][k] == '#' && arr[j][k+1]=='#') { temp1++; }
                ...
                else{ if(temp1>upper){ upper=temp1; } temp1=1; }  
        ...
        for(int j=0; j<n; j++){
            ...
            for(int k=0; k<m; k++){
                ...
                if (j==n-1 && arr[j][k] == '#' && arr[j][k+1]=='#') { temp1++; }
                ...
                else{ if(temp2>lower){ lower=temp2; } temp2=1; }  
        ...
        for(int k=0; k<m; k++){
            ...
            for(int j=0; j<n; j++){
                ...
                if (k==0 && arr[j][k] == '#' && arr[j+1][k]=='#') { temp3++; }
                ...
                else{ if(temp3>left){ left=temp3; } temp3=1; }    
        ...
        for(int k=0; k<m; k++){
            ...
            for(int j=0; j<n; j++){
                ...
                if (k==m-1 && arr[j][k] == '#' && arr[j+1][k]=='#') { temp4++; }
                ...
                else{ if(temp4>right){ right=temp4; } temp4=1; }  
